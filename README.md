# Onboarding / Offboarding Task Tracking FedMake Accelerator

Government focused Employee Onboarding / Offboarding Task Tracking FedMake Accelerator Developed at a FedMake Event by Makers within the Federal, Intel, and Dept of Defense organizations.
...
Please report bugs and other code issues [here](https://github.com/FedMake/onboarding-offboarding-task-tracking/issues/new).
...
This app template is provided under the [MIT License](https://github.com/FedMake/onboarding-offboarding-task-tracking/blob/main/LICENSE) terms.  In addition to these terms, by using this app template you agree to the following:
